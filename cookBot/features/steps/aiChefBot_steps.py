...
from home.chefBot import collect_context_from_recipes, build_messages, SYSTEM_PROMPT, call_openai
import json
import urllib.error
...
def step_send_valid_message(context):
    ...
    with patch('home.views.call_openai', return_value='Here is a great recipe!') as mock:
